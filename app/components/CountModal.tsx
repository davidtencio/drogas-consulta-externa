...
type Props = {
  medicine: Medicine | undefined; activePharmacists: Pharmacist[]; busy: boolean; error?: string;
...
export function CountModal({ medicine, activePharmacists, busy, error, onClose, onSubmit }: Props) {
